...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nrepl-sync gh alect-themes benchmark-init dired fsharp-mode haskell-mode alecs-theme dired+ go-mode beacon sml-modeline base16-theme quack zenburn rainbow-delimeters company-mode centered-window-mode sound-wav helm-config neotree rainbow-delimiters try request ## cider))))
(custom-set-faces
